								...
								<table class="table table-bordered" id="datatable" >
									...
									<?php
										...
										echo "<td>$jenis[nama_jenis]</td>
											  <td class='center'>$barang[total]</td>
											  <td class='center'>$barang[stock]</td>
											  <td><a class='btn btn-prusia' href='?user=admin&halaman=tampil_detil_barang2&id_barang=$barang[id_barang]'><i class='fa fa-eye'></i>Detil</a></td>
