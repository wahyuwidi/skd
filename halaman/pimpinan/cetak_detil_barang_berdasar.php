...
where detil_barang.id_barang=barang.id_barang and barang.jenis=jenis_barang.id_jenis and 
$kategori LIKE '%$keyword%' order by id_detil";	
}
else{
$query="SELECT detil_barang.*, barang.*, jenis_barang.* FROM detil_barang, barang, jenis_barang
where detil_barang.id_barang=barang.id_barang and barang.jenis=jenis_barang.id_jenis order by id_detil";	
}   
