...
class FPDF_AutoWrapTable extends FPDF {
	...
	public function rptDetailData () {
		...
		$this->SetX($left += 30); $this->Cell(150, $h, 'NAMA LENGKAP', 1, 0, 'C',true);
		$this->SetX($left += 150); $this->Cell(90, $h, 'JABATAN', 1, 0, 'C',true);
		$this->SetX($left += 90); $this->Cell(90, $h, 'USERNAME', 1, 0, 'C',true);
		$this->SetX($left += 90); $this->Cell(90, $h, 'PASSWORD', 1, 0, 'C',true);			
		$this->SetX($left += 90); $this->Cell(80, $h, 'HAK AKSES', 1, 0, 'C',true);
		$this->Ln(20);
		
		$this->SetFont('Arial','',9);
		$this->SetWidths(array(30,150,90,90,90,80));
...
$query="select * from user where $kategori LIKE '%$keyword%' order by nama ";
