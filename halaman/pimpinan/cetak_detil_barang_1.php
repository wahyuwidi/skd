...
class FPDF_AutoWrapTable extends FPDF {
	...
	public function rptDetailData () {
		...
		$this->setX(50);$this->MultiCell(0,5,"DATA RINCIAN MODEM (MAC ADDRESS)",0,'C',0);
...
$query = mysql_query("SELECT detil_barang.*, jenis_barang.*, barang.* from detil_barang, barang, jenis_barang where barang.id_barang='$id_barang' and detil_barang.id_barang='$id_barang' and jenis_barang.id_jenis=barang.jenis order by id_detil");
