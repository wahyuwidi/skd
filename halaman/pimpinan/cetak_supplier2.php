...
class FPDF_AutoWrapTable extends FPDF {
	...
	public function rptDetailData () {
		...
		$this->setX(50);$this->MultiCell(0,5,"DATA SUPPLIER",0,'C',0);
		...
		$this->SetX($left += 30); $this->Cell(60, $h, 'ID SUPPLIER', 1, 0, 'C',true);
		$this->SetX($left += 60); $this->Cell(150, $h, 'NAMA SUPPLIER', 1, 0, 'C',true);
		$this->SetX($left += 150); $this->Cell(200, $h, 'ALAMAT', 1, 0, 'C',true);
		$this->SetX($left += 200); $this->Cell(80, $h, 'NO TELP', 1, 0, 'C',true);
		$this->Ln(20);
		
		$this->SetFont('Arial','',9);
		$this->SetWidths(array(30,60,150,200,80));
		$this->SetAligns(array('C','C','L','L','L'));
...
$query="select * from supplier where $kategori LIKE '%$keyword%' order by id_supplier ";
