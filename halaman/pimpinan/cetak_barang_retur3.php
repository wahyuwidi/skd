...
class FPDF_AutoWrapTable extends FPDF {
	...
	public function rptDetailData () {
		...
		$this->setX(50);$this->MultiCell(0,5,"DATA MODEM RETUR",0,'C',0);
		$this->Cell(132);
...
and $kategori LIKE '%$keyword%' order by retur.tgl_retur asc";	
}
else{
$query="select retur.*, barang_keluar.*, detil_barang.*, barang.*, jenis_barang.* from
retur, barang_keluar, detil_barang, barang, jenis_barang where
retur.id_keluar=barang_keluar.id_keluar and barang_keluar.id_detil=detil_barang.id_detil and
detil_barang.id_barang=barang.id_barang and barang.jenis=jenis_barang.id_jenis order by retur.tgl_retur asc";	
}
